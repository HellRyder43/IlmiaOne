  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/resident/billing" className="group">
           <Card className="h-full hover:shadow-md transition-shadow">
             <CardContent className="pt-6">
               ...
               <p className="text-sm text-slate-500 mt-1 mb-4">View your maintenance invoices.</p>
        ...
        <Link href="/resident/calendar" className="group">
           <Card className="h-full hover:shadow-md transition-shadow">
             <CardContent className="pt-6">
               <div className="w-12 h-12 bg-emerald-100 rounded-lg shadow-sm flex items-center justify-center mb-4 text-emerald-600 group-hover:scale-110 transition-transform">
                 <Calendar className="w-6 h-6" />
               </div>
               <h3 className="font-semibold text-slate-900">Community Events</h3>
               <p className="text-sm text-slate-500 mt-1 mb-4">No upcoming events.</p>
               <div className="flex items-center text-indigo-600 text-sm font-medium">
      ...
      <Card className="border border-slate-200 shadow-sm bg-white">
        ...
        <CardContent className="p-0">
           <div className="py-12 text-center">
             ...
             <p className="text-xs text-slate-400 mt-1">Your activity will show up here.</p>
           </div>
        </CardContent>
      </Card>
